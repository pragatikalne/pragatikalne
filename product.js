        ...
        <div class="card-body text-center">
          ...
          <p class="fs-5">Lorem ipsum dolor sit amet, consectetur 
            ...
            <button type="button" class="btn btn-Output-warning
             text-success rounded-pill " onclick=addtocart(${prod.id})>
...
{
    items.slice(7,12).map((prod)=>{vegesel.innerHTML+=`
        <div class="col">
        ...
        <div class="col">
              <div class="card">
                ...
                <div class="card-body text-center">
                  ...
                  <p class="fs-5">Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod te incididunt</p>
                  <h5>$${prod.price} / kg</h5>
                  <button type="button" class="btn btn-outline-warning text-success
                   rounded-pill">
                    <i class="fa-solid fa-bag-shopping me-2"></i> Add to cart
                  </button>
                </div>
...
function displaycartitems()
{
  cart.map((c)=>{
    ...
    cartel.innerHTML+=
    `<tr>
    <td><img src=${c.image} height=80 widht=80></td>
    <td>${c.name}</td>
    <td>${c.price}</td>
            <i class="fa-solid fa-bag-shopping me-2"></i>Add to card
    <td><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
       fill="currentColor" class="bi bi-dash-circle" viewBox="0 0 16 16"
        onclick="changeqty("minus",${c.id})">
  <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
  <path d="M4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8"/>
</svg> ${c.qty} <svg xmlns="http://www.w3.org/2000/svg" width="16"
 height="16" fill="currentColor" class="bi bi-plus-circle" 
 viewBox="0 0 16 16" onclick="changeqty("plus",${c.id})">
  <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
  <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1
   0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
    ...
    <td><i class="fa-solid fa-trash text-danger fs-4"></i></td>
    </tr>
    `
  })
}
